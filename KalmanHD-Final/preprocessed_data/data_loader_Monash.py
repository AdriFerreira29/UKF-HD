# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 11:01:08 2022

This is a utility .py file used to load a dataset that belongs to the
Monash University repo

https://github.com/rakshitha123/TSForecasting/blob/master/utils/data_loader.py

https://forecastingdata.org/#:~:text=Our%20aim%20is%20to%20introduce,use%20only%20for%20research%20purpose.
...
from distutils.util import strtobool  # numpy.distutils foi removido; strtobool vem do shim do setuptools
import pandas as pd

# Converts the contents in a .tsf file into a dataframe and returns it along with other meta-data of the
#dataset: frequency, horizon, whether the dataset contains missing values and whether the series have equal lengths
#
# Parameters
