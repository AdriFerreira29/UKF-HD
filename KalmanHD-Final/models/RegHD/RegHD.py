...
class RegHD(nn.Module):
        ...
        for _ in range(epochs): # Number of iterations for all the samples
            ...
            for n in tqdm(range(size)):
                ...
                if (n % self.opt.print_freq == 0 and n != 0):
                    ...
                    print(f"Cross Validation root mean squared error of {(mean_squared_error(labels_full, pred) ** 0.5):.3f}")
    ...
    def test(self, sets_testing, matrix_1_norm, matrix_1_norm_org, y, cv = True):
        ...
        if (not cv):
            error = mean_squared_error(labels_full, pred) ** 0.5
            print(
    ...
    """ def test2(self, start_testing, matrix_1_norm, number_predictions):
        ...
        print(
            f"Testing root mean squared error of testing {(mean_squared_error(labels_full.flatten(), y[:, -number_predictions:].flatten()) ** 0.5):.3f}")
...
class RegHD_Kmeans(RegHD):
    ...
    def train(self, sets_training, matrix_1_norm, epochs):
        ...
        for _ in range(epochs): # Number of iterations for all the samples
            ...
            print(f"Training root mean squared error of {(mean_squared_error(labels_full, pred) ** 0.5):.3f}")
